...
public class CsMenuActivity extends AppCompatActivity {
    ...
    public void setButtons(){
        ...
        buttons[2] = (Button) findViewById(R.id.btnDmnd);
        buttons[2].setOnClickListener(d);

        buttons[3] = (Button) findViewById(R.id.btnBack);
        buttons[3].setOnClickListener(bh);
        //setupButton();
    ...
    public void updateView() throws NullPointerException{
        ...
        TextView mD = (TextView) findViewById(R.id.movesD);
    ...
    public void startSquare(View v){
        ...
        Intent square = new Intent(CsMenuActivity.this, CrossActivity.class);
        startActivity(square, ActivityOptions.makeSceneTransitionAnimation(CsMenuActivity.this).toBundle());
    }
    ...
    public void startDmnd(View v){
        ...
        getWindow().setExitTransition(new Explode());
        Intent dmnd = new Intent(CsMenuActivity.this, CrossActivity.class);
        startActivity(dmnd, ActivityOptions.makeSceneTransitionAnimation(CsMenuActivity.this).toBundle());
    }
